...
It sets up a security and alerting baseline.
...
| <a name="input_greetee"></a> [greetee](#input\_greetee) | The greetee | `string` | `"Engineer!"` | no |
| <a name="input_greeting"></a> [greeting](#input\_greeting) | The greeting | `string` | n/a | yes |
